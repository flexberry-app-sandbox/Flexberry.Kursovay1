...
CREATE INDEX Index68cdd071f8f3c1def6a6830da38eab96386d73e3 on ТоварНаСкладе (Склад); 
 ...
 ALTER TABLE Хранилище ADD CONSTRAINT FK28f187cd8dafce627331cc766ead8bb18f49ae0e FOREIGN KEY (Склад) REFERENCES Склад; 
CREATE INDEX Index28f187cd8dafce627331cc766ead8bb18f49ae0e on Хранилище (Склад); 
